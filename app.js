...
app.get('/post/:postId',function(req,res){
  ...
  posts.forEach(function (elements) {
    const requestedpost = _.lowerCase(requestedTitles)
    if(elements.title === _.lowerCase(requestedTitles)){
      res.render("post",{requestedTitles:requestedTitles,requestedpost: elements.content})
    }
  })
},)
